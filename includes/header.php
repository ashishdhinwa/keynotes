 ...
 <div class="navbar-header" style="margin-left:-29px;">
  <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#myNavbar">
				...
				<img src="../pictures/logo2.jpg" style="max-height:60px;max-width:60px;border-style:solid;border-radius:100%;position:relative;right:210px;bottom:5px;"></img><a href="index.php" class="navbar-brand" style="font-size:24px;color:#F3670C;margin-left:15px;">&nbsp;Key Notes</a>
                </div>
	...
	<ul class="dropdown-menu">
	  ...
	  <li class="dropdown">
	  <!--Try to make theglyphicon folder close to folder open using javascript-->
	  <a class="dropdown-toggle" data-toggle="dropdown" style="cursor: pointer;font-size:15px;"><span class="glyphicon glyphicon-folder-close"></span>&nbsp;Question Papers<span class="caret"></span></a>
	<ul class="dropdown-menu">
       	 <li><a href="#">Computer Science</a></li>
		  <li><a href="#">Electrionics & Comm. Engg.</a></li>
