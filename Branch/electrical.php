...
<body>
  ...
  ?>
 <h5 style="margin-top:-5px;margin-bottom:-5px;font-size:15px;"><i><b>Electrical Engineering</b></i></h5>
  </center>
  <hr>
   ...
   <div class="row">
	  <div class="col-lg-4">
	  <a href="../Final_page/Ele/ele_edc.php">
	  <div class="thumbnail">
	    ...
	    <div class="col-lg-4">
	 	  <a href="../Final_page/Ele/ele_nt.php">
	 <div class="thumbnail">
	    ...
	    <div class="col-lg-4">
		 <a href="../Final_page/Ele/ele_machines.php">
	  <div class="thumbnail">
		<img src="../gif/electricalmachine.gif" alt="cannot display" style="border-style:solid;border-color:white;border-radius:80%;border-width:3px;max-width:800%;max-height:80%;"></img>
		<h5><strong>&nbsp;&nbsp;&nbsp;Electrical Machines-I</strong></h5>
		</div>
		</a>
	   </div>
   </div>
   ...
   <div class="row">
    <div class="col-lg-4">
	 <a href="../Final_page/Ele/ele_psp.php">
	  <div class="thumbnail">
		<img src="../gif/power.gif" alt="cannot display" style="border-style:solid;border-color:white;border-radius:80%;border-width:3px;max-width:800%;max-height:80%;"></img>
		<h5><strong>&nbsp;&nbsp;Power Station Practices</strong></h5>
		</div>
		</a>
	   </div>
	    <div class="col-lg-4">
	  ...
	  <div class="thumbnail">
		<img src="../gif/measu.gif" alt="cannot display" style="border-style:solid;border-color:white;border-radius:80%;border-width:3px;max-width:800%;max-height:80%;"></img>
		<h5><strong>&nbsp;&nbsp;&nbsp; Electrical Measurement-Instrument..</strong></h5>
		</div>
		</a>
	   </div>
   ...
   <hr/>
   <h5 id="electricalsyllabus" style="color:green;margin-bottom:-10px;font-style:italic;"><strong>SCHEME & SYLLABUS</strong></h5>
    <h6 style="color:brown;margin-bottom:-10px;font-style:italic;"><strong>(Only for MNIT Jaipur students)</strong></h6>
	<hr  style="height:1px;border:none;color:#333;background-color:#333;">
    <div class="row">
	    <div class="col-lg-4">
		 <a href="https://drive.google.com/file/d/1JCYRqy9Zr5T4OjyZDIVXQiAN5iH2UlY3/view?usp=sharing">
	  <div class="thumbnail">
