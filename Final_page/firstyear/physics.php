...
<body>
 ...
 <?php
  ...
  ?>
  <center><h5><b>Physics</b></h5></center>
  <hr>
  ...
  <div class="container" style="width:90%;">
    ...
    <ul class="dropdown-menu" style="width:100%;">
      <li><a href="https://drive.google.com/file/d/1z7xFU-WQZ15u5aS5KsVnsET8-mLSKhTx/view?usp=sharing">Notes-1</a></li>
	  <hr  style="height:1px;border:none;color:#333;background-color:#333;margin-top:2px;margin-bottom:3px;">
	  <li><a href="https://drive.google.com/file/d/1gprfIkETkJajgDGQ3eCen-iniqgIsi8h/view?usp=sharing">Notes-2</a></li>
	 <hr>
	  <hr>
