...
<body>
 ...
 <?php
  ...
  ?>
  <center><h5><b>Electrical Machines</b></h5></center>
  <hr>
  ...
  <div class="container" style="width:90%;">
    ...
    <ul class="dropdown-menu" style="width:100%;">
      <li><a href="https://drive.google.com/file/d/1gxjPXM5nqSpdIWRoHL8xULJ3XI1CfLMh/view?usp=sharing">Notes-1</a></li>
	  <hr  style="height:1px;border:none;color:#333;background-color:#333;margin-top:2px;margin-bottom:3px;">
	    <li><a href="https://drive.google.com/file/d/1CpGOmLOCVUav0Q_WKiUZXQJr3CP9iZIl/view?usp=sharing">Notes-2</a></li>
	  <hr  style="height:1px;border:none;color:#333;background-color:#333;margin-top:2px;margin-bottom:3px;">
	  <hr>
    </ul>
  </div>
