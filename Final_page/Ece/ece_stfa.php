...
<body>
 ...
 <?php
  ...
  ?>
  <center><h5><b>Switching Theory & Finite Automata</b></h5></center>
  <hr>
  ...
  <div class="container" style="width:90%;">
    ...
    <ul class="dropdown-menu" style="width:100%;">
      <li><a href="https://drive.google.com/file/d/1VRMmw4GuwNEa7lzDXJZp6EYDDqLMaxO2/view?usp=sharing">Stfa part-1</a></li>
	  <hr  style="height:1px;border:none;color:#333;background-color:#333;margin-top:2px;margin-bottom:3px;">
	  <li><a href="https://drive.google.com/file/d/1YLGnmo2E26ao_iO0N07zOeArfs7x5Ud5/view?usp=sharing">Stfa part-2</a></li>
	  <hr  style="height:1px;border:none;color:#333;background-color:#333;margin-top:2px;margin-bottom:3px;">
	  <li><a href="https://drive.google.com/file/d/12aIQLRuzvsbVIRzJlZL1bBw-CdelODZB/view?usp=sharing">Stfa part-3</a></li>
	  <hr  style="height:1px;border:none;color:#333;background-color:#333;margin-top:2px;margin-bottom:3px;">
      <li><a href="https://drive.google.com/file/d/1Vt2WhlU8H6miIiflbniadHYbmDD5MFe3/view?usp=sharing">HDL-1</a></li>
      <hr  style="height:1px;border:none;color:#333;background-color:#333;margin-top:2px;margin-bottom:3px;">
	  <li><a href="https://drive.google.com/file/d/1iF5sproKE-vlBut1glPEUS75U8vYo1H_/view?usp=sharing">HDL-2</a></li>
      <hr  style="height:1px;border:none;color:#333;background-color:#333;margin-top:2px;margin-bottom:3px;">
	  <li><a href="https://drive.google.com/file/d/1wB9HAmbCfXuWpD0Em3hgDhQ1DIAOdW_P/view?usp=sharing">HDL-3</a></li>
      <hr  style="height:1px;border:none;color:#333;background-color:#333;margin-top:2px;margin-bottom:3px;">
	  <li><a href="https://drive.google.com/file/d/1wqpJHw3GJ9U-zewnds1VO-6QOYB6zgb9/view?usp=sharing">HDL-4</a></li>
      <hr  style="height:1px;border:none;color:#333;background-color:#333;margin-top:2px;margin-bottom:3px;">
	  <li><a href="https://drive.google.com/file/d/1D6Rkfn7nVdI-6uaM2ZM2jv6-bVWOVk5d/view?usp=sharing">Floating Point</a></li>
    </ul>
  </div>
			 </div>
	...
	<span class="caret"></span></button>
    <ul class="dropdown-menu" style="width:100%;">
      <li><a href="https://drive.google.com/file/d/1Yt5cZlTZT6ax0wN-CscxgumGf2Exgf0D/view?usp=sharing">Lab File</a></li>
