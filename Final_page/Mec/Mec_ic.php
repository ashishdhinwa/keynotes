...
<body>
 ...
 <?php
  ...
  ?>
  <center><h5><b>I.C. Engines</b></h5></center>
  <hr>
  ...
  <div class="container" style="width:90%;">
    ...
    <ul class="dropdown-menu" style="width:100%;">
	  ...
	  <li><a href="https://drive.google.com/open?id=1e4ZtDSbcqyaspEwEQbOgTBeUhI2DvflV">I.C. Engine Part-1</a></li>
	  <hr  style="height:1px;border:none;color:#333;background-color:#333;margin-top:2px;margin-bottom:3px;">
	 
	  <li><a href="https://drive.google.com/open?id=16LalsaOnaqkMf5mioTH1LA2ZOQyF5wrf">I.C. Engine Part-2</a></li>
	  <hr  style="height:1px;border:none;color:#333;background-color:#333;margin-top:2px;margin-bottom:3px;">
	   <hr>
