...
<body>
  ...
  <!--In the sign up page we will ask the gender and accordingly we will write Mr. or Miss-->
  <?php
  include "../includes/fetchname_to_print.php";
  ?>
  <h5 style="margin-top:-5px;margin-bottom:-5px;font-size:15px;"><i><b>Computer Science & Engineering</b></i></h5>
  </center>
  <hr>
   ...
   <div class="row">
	  ...
	  <div class="thumbnail">
		...
		<h5><strong>&nbsp;&nbsp;&nbsp;Logic In Computing</strong></h5>
		</div>
		</a>
	   </div>
	 ...
	 <div class="thumbnail">
	  ...
	  <div class="thumbnail">
		...
		<h5><strong>&nbsp;&nbsp;&nbsp;Programming Methodology</strong></h5>
		</div>
		</a>
	   </div>
   </div>
   ...
   <div class="row">
    <div class="col-lg-4">
	 <a href="../Final_page/cs/ece_pmss.php">
	  <div class="thumbnail">
		...
		<h5><strong>&nbsp;&nbsp;Introduction to signals & Systems</strong></h5>
		</div>
		</a>
	   </div>
	    <div class="col-lg-4">
		 <a href="../Final_page/cs/ece_stfa.php">
	  <div class="thumbnail">
		...
		<h5><strong>&nbsp;&nbsp;&nbsp;Digital Logic Design</strong></h5>
		</div>
		</a>
	   </div>
	    <div class="col-lg-4">
		 <a href="../Final_page/cs/ece_dsa.php">
	  <div class="thumbnail">
   ...
   <hr/>
   <h5 id="cssyllabus" style="color:green;margin-bottom:-10px;font-style:italic;"><strong>SCHEME & SYLLABUS</strong></h5>
    ...
    <div class="row">
	   ...
	   <div class="col-lg-4">
		 <a href="https://drive.google.com/file/d/1q35SnjhuapXTKuhb75nsQZ7eqEIJorXD/view?usp=sharing">
	  <div class="thumbnail">
		...
		<h5 ><strong>&nbsp;&nbsp;&nbsp;Syllabus-1</strong></h5>
		</div>
		</a>
	   </div>
	   <div class="col-lg-4">
		 <a href="https://drive.google.com/file/d/1ajsSIF6ecfhpOd2np-2Fzfq80sUY_cqF/view?usp=sharing">
	  <div class="thumbnail">
		<img src="../gif/syllabus.gif" alt="cannot display" style="border-style:solid;border-color:white;border-radius:80%;border-width:3px;max-width:800%;max-height:80%;"></img>
		<h5 ><strong>&nbsp;&nbsp;&nbsp;Syllabus-2</strong></h5>
		</div>
		</a>
	   </div>
   </div>
