...
<html>
   <head>
   <title>Chemical_ Energy Resources Utilization</title>
   <meta charset="UTF-8">
...
<body>
 ...
 <?php
  ...
  <div class="container" style="width:90%;">
   ...
   <span class="caret"></span></button>
    <ul class="dropdown-menu" style="width:100%;">
      <li><a href="../../Chemical engineering/Chemical eng last year 3rd sem qn papers">2017 Qn Papers(All Subjects)</a></li>
