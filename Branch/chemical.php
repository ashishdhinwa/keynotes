...
<body>
  ...
  ?>
 <h5 style="margin-top:-5px;margin-bottom:-5px;font-size:15px;"><i><b>Chemical Engineering</b></i></h5>
  </center>
  <hr>
   ...
   <div class="row">
	  <div class="col-lg-4">
	   <a href="../Final_page/Chemical/chemical_ps.php">
	  <div class="thumbnail">
		<img src="../gif/Process.gif" alt="cannot display" style="border-style:solid;border-color:white;border-radius:80%;border-width:3px;max-width:800%;max-height:80%;"></img>
		<h5><strong>&nbsp;&nbsp;&nbsp;Process Instrumentation</strong></h5>
		</div>
		</a>
	   </div>
	 ...
	 <div class="thumbnail">
		<img src="../gif/numerical1.gif" alt="cannot display" style="border-style:solid;border-color:white;border-radius:80%;border-width:3px;max-width:800%;max-height:80%;"></img>
		<h5><strong>&nbsp;&nbsp;&nbsp;Numerical Methods in C.E.</strong></h5>
		</div>
		</a>
	   </div>
	    <div class="col-lg-4">
		   <a href="../Final_page/firstyear/void.php">
	  <div class="thumbnail">
		<img src="../gif/energy1.gif" alt="cannot display" style="border-style:solid;border-color:white;border-radius:80%;border-width:3px;max-width:800%;max-height:80%;"></img>
		<h5><strong>&nbsp;&nbsp;&nbsp; Energy Resources Utilization</strong></h5>
		</div>
		</a>
	   </div>
   </div>
   ...
   <div class="row">
    <div class="col-lg-4">
	  <a href="../Final_page/firstyear/void.php">
	  <div class="thumbnail">
		<img src="../gif/chemicalprocess.gif" alt="cannot display" style="border-style:solid;border-color:white;border-radius:80%;border-width:3px;max-width:800%;max-height:80%;"></img>
		<h5><strong>&nbsp;&nbsp;Chemical Process Calculations</strong></h5>
		</div>
		</a>
	   </div>
	    <div class="col-lg-4">
		  <a href="../Final_page/firstyear/void.php">
	  <div class="thumbnail">
		<img src="../gif/thermo.gif" alt="cannot display" style="border-style:solid;border-color:white;border-radius:80%;border-width:3px;max-width:800%;max-height:80%;"></img>
		<h5><strong>&nbsp;&nbsp;&nbsp;Chemical Engineering Thermo-I</strong></h5>
		</div>
		</a>
	   </div>
	    <div class="col-lg-4">
		 <a href="../Final_page/firstyear/void.php">
	  <div class="thumbnail">
		<img src="../gif/momentum.gif" alt="cannot display" style="border-style:solid;border-color:white;border-radius:80%;border-width:3px;max-width:800%;max-height:80%;"></img>
		<h5><strong>&nbsp;&nbsp;&nbsp;Momentum Transfer Operations</strong></h5>
		</div>
		</a>
	   </div>
   ...
   <hr/>
   <h5 id="chemicalsyllabus" style="color:green;margin-bottom:-10px;font-style:italic;"><strong>SCHEME & SYLLABUS</strong></h5>
    <h6 style="color:brown;margin-bottom:-10px;font-style:italic;"><strong>(Only for MNIT Jaipur students)</strong></h6>
	<hr  style="height:1px;border:none;color:#333;background-color:#333;">
    <div class="row">

	    <div class="col-lg-4">
		 <a href="https://drive.google.com/file/d/13H4Wi66s74f4PyKlKfBPIscSV75_4I9G/view?usp=sharing">
	  <div class="thumbnail">
