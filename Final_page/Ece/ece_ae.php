...
<body>
 ...
 <?php
  ...
  ?>
  <center><h5><b>Applied Electronics</b></h5></center>
  <hr>
  ...
  <div class="container" style="width:90%;">
    ...
    <ul class="dropdown-menu" style="width:100%;">
      <li><a href="https://drive.google.com/open?id=1SA-FeW-S46iMFZ7YUAU6AxBQZZsYQHIb">Phase Locked Loop</a></li>
	  <hr  style="height:1px;border:none;color:#333;background-color:#333;margin-top:2px;margin-bottom:3px;">
	  <li><a href="https://drive.google.com/open?id=1zdO1Foge-p5JcITt70IusWfHDfIQvR2g">Assignment 1</a></li>
	  <hr  style="height:1px;border:none;color:#333;background-color:#333;margin-top:2px;margin-bottom:3px;">
	 
	  <li><a href="https://drive.google.com/open?id=1vTC2-yhwbYgzUH3JklnnBn7BiYg-Fk1N">M.T.E. 1 Solutions</a></li>
	  <hr  style="height:1px;border:none;color:#333;background-color:#333;margin-top:2px;margin-bottom:3px;">
	   <li><a href="https://drive.google.com/open?id=1dwzTCriMp6Nvcp1_n990aMOtDrljARE-">M.T.E. 2 Solutions</a></li>
	  <hr  style="height:1px;border:none;color:#333;background-color:#333;margin-top:2px;margin-bottom:3px;">
    ...
    <span class="caret"></span></button>
    <ul class="dropdown-menu" style="width:100%;">
      <li><a href="https://drive.google.com/open?id=1spt_EGjGyQf_liu5O-AEMiZ9BJ2bnUsB">Lab File -1</a></li>
	  <hr  style="height:1px;border:none;color:#333;background-color:#333;margin-top:2px;margin-bottom:3px;">
	  <li><a href="https://drive.google.com/open?id=1v09TVdvTMWU_gS9NjsKWlkapIoArVf0C">Lab File -2</a></li>
	  <hr  style="height:1px;border:none;color:#333;background-color:#333;margin-top:2px;margin-bottom:3px;">
	   <hr>
	   <hr>
  ...
  <br>
  <br>
  <center><h4 style="color:red;">We do not guarantee you for the 100% accuracy of the content available here.</h4></center>
  <?php
  include "deepika_gupta.php";
  ?>
  <br>
  <br>
