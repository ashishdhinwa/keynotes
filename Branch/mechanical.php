...
<body>
  ...
  ?>
 <h5 style="margin-top:-5px;margin-bottom:-5px;font-size:15px;"><i><b>Mechanical Engineering</b></i></h5>
  </center>
  <hr>
   ...
   <div class="row">
	  <div class="col-lg-4">
	  <a href="../Final_page/Mec/Mec_thermo">
	  <div class="thumbnail">
		...
		<h5><strong>&nbsp;&nbsp;&nbsp;Engineering Thermodynamics</strong></h5>
		</div>
		</a>
	   </div>
	   
	    <div class="col-lg-4">
	 	  <a href="../Final_page/Mec/Mec_FM">
	 <div class="thumbnail">
		...
		<h5><strong>&nbsp;&nbsp;&nbsp;Fluid Mechanics & Machines
</strong></h5>
		</div>
		</a>
	   </div>
	  ...
	  <div class="thumbnail">
		...
		<h5><strong>&nbsp;&nbsp;&nbsp; Engineering Mechanics</strong></h5>
		</div>
		</a>
	   </div>
   </div>
   ...
   <div class="row">
    <div class="col-lg-4">
	 <a href="../Final_page/Mec/Mec_CFW">
	  <div class="thumbnail">
		<img src="../gif/welding.gif" alt="cannot display" style="border-style:solid;border-color:white;border-radius:80%;border-width:3px;max-width:800%;max-height:80%;"></img>
		<h5><strong>&nbsp;&nbsp;Casting, Forming and Welding</strong></h5>
		</div>
		</a>
	   </div>
	    <div class="col-lg-4">
		 <a href="../Final_page/Mec/Mec_MaterialScience">
	  <div class="thumbnail">
		...
		<h5><strong>&nbsp;&nbsp;&nbsp;Material Science</strong></h5>
		</div>
		</a>
	   </div>
	    <div id="mechanicalsyllabus" class="col-lg-4">
		 <a href="../Final_page/Mec/Mec_mathematics">
	  <div class="thumbnail">
   ...
   <h5  style="color:green;margin-bottom:-10px;font-style:italic;"><strong>SCHEME & SYLLABUS</strong></h5>
	...
	<div class="row">
	    ...
	    <div class="col-lg-4">
		 <a href="https://drive.google.com/file/d/1Ot1dMhs7HtNuP5FzNHdPd2hGbL5dwU_g/view?usp=sharing">
	  <div class="thumbnail">
    ...
    <br/>
	    <hr  style="height:1px;border:none;color:#333;background-color:#333;">
		  <div class="row">
	<div class="col-lg-4">
		 <a href="https://drive.google.com/file/d/1Y_eTYJ5XOegARXvxUCko8pYl4s258iQS/view?usp=sharing">
	  <div class="thumbnail">
		...
		<h5><strong>&nbsp;&nbsp;&nbsp;Inventor assignments</strong></h5>
		</div>
		</a>
	   </div>
	  <div class="col-lg-4">
		 <a href="https://drive.google.com/file/d/1zs4bqddv0MXH55tAgDfS3VWczdPFc2MI/view?usp=sharing">
	  <div class="thumbnail">
		<img src="../gif/lic.gif" alt="cannot display" style="border-style:solid;border-color:white;border-radius:80%;border-width:3px;max-width:800%;max-height:80%;"></img>
		<h5><strong>&nbsp;&nbsp;&nbsp;Important book links</strong></h5>
		</div>
		</a>
	   </div>
